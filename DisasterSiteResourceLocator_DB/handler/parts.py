...
class PartHandler:
    ...
    def build_part_attributes(self, pid, pname, pcolor, pmaterial, pprice): #this is for inserting
        result = {}
        result['pid'] = pid
        result['pname'] = pname
